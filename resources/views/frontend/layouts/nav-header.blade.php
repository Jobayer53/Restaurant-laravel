      ...
      <div class="collapse navbar-collapse" id="navbarScroll">
        ...
        <form class="d-flex" role="search">
          <ul class="navbar-nav me-2 ">
            ...
            <a href="{{ route('cart') }}" class="nav-link me-4" style="color: white;">
                <i>
                ...
                <span class="badge rounded-pill text-bg-warning" style="    position: relative;top: -12px;    left: -7px;font-size: 12px;">{{ $totalProducts }}</span>
            </a>
            </li>
            <li>
